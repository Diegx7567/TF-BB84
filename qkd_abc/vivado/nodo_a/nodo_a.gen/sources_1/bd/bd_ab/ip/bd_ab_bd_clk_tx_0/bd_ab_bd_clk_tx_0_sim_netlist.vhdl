...
--               c:/Users/diego/Documents/TF-BB84/qkd_abc/vivado/nodo_a/nodo_a.gen/sources_1/bd/bd_ab/ip/bd_ab_bd_clk_tx_0/bd_ab_bd_clk_tx_0_sim_netlist.vhdl
-- Design      : bd_ab_bd_clk_tx_0
...
entity bd_ab_bd_clk_tx_0_clk_wiz is
  port (
...
end bd_ab_bd_clk_tx_0_clk_wiz;

architecture STRUCTURE of bd_ab_bd_clk_tx_0_clk_wiz is
  signal clk_in1_bd_ab_bd_clk_tx_0 : STD_LOGIC;
  signal clk_out1_bd_ab_bd_clk_tx_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_bd_ab_bd_clk_tx_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 96.875000,
      ...
      CLKIN1 => clk_in1_bd_ab_bd_clk_tx_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_bd_ab_bd_clk_tx_0,
...
entity bd_ab_bd_clk_tx_0 is
  ...
  attribute NotValidForBitStream of bd_ab_bd_clk_tx_0 : entity is true;
end bd_ab_bd_clk_tx_0;

architecture STRUCTURE of bd_ab_bd_clk_tx_0 is
begin
inst: entity work.bd_ab_bd_clk_tx_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
