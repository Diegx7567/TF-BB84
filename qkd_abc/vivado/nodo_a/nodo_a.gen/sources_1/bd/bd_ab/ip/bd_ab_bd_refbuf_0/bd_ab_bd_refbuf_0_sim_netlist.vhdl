...
-- Date        : Wed Sep  9 11:58:12 2026
-- Host        : ArcosLaptop running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/diego/Documents/TF-BB84/qkd_abc/vivado/nodo_a/nodo_a.gen/sources_1/bd/bd_ab/ip/bd_ab_bd_refbuf_0/bd_ab_bd_refbuf_0_sim_netlist.vhdl
-- Design      : bd_ab_bd_refbuf_0
...
entity bd_ab_bd_refbuf_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of bd_ab_bd_refbuf_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of bd_ab_bd_refbuf_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of bd_ab_bd_refbuf_0_util_ds_buf : entity is "ibufdsgte4";
  attribute C_MODE : string;
  attribute C_MODE of bd_ab_bd_refbuf_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of bd_ab_bd_refbuf_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of bd_ab_bd_refbuf_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of bd_ab_bd_refbuf_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of bd_ab_bd_refbuf_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bd_ab_bd_refbuf_0_util_ds_buf : entity is "util_ds_buf";
end bd_ab_bd_refbuf_0_util_ds_buf;

architecture STRUCTURE of bd_ab_bd_refbuf_0_util_ds_buf is
...
entity bd_ab_bd_refbuf_0 is
  ...
  attribute NotValidForBitStream of bd_ab_bd_refbuf_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_ab_bd_refbuf_0 : entity is "bd_ab_bd_refbuf_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of bd_ab_bd_refbuf_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of bd_ab_bd_refbuf_0 : entity is "util_ds_buf,Vivado 2025.1";
end bd_ab_bd_refbuf_0;

architecture STRUCTURE of bd_ab_bd_refbuf_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_ab_bd_refbuf_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_ab_bd_refbuf_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.bd_ab_bd_refbuf_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
