...
HD_PWD='C:/Users/diego/Documents/TF-BB84/qkd_abc/vivado/nodo_a/nodo_a.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_ab_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_ab_wrapper.tcl -notrace
