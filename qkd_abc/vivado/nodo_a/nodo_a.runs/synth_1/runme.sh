...
HD_PWD='C:/Users/diego/Documents/TF-BB84/qkd_abc/vivado/nodo_a/nodo_a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_ab_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_ab_wrapper.tcl
